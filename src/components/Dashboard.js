  ...
  return (
    <Grid container spacing={3}>
          ...
          <CardContent>
            ...
            {daysAdjustments.length > 0 && (
              <Typography
                variant="caption"
                color={
                  calculateAdjustments().additions -
                    calculateAdjustments().subtractions >=
                  0
                    ? "success.main"
                    : "error.main"
                }
          ...
          <CardContent>
            ...
            >
              ...
              <Button
                ...
                disabled={
                  !userData?.availableDays || userData.availableDays <= 0
                }
              >
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete this time off request? This will add{" "}
            {entryToDelete?.days} days back to your remaining days.
          </Typography>
        </DialogContent>
        <DialogActions>
